/*
 * Script Name: Mass Scavenging Unlock and Mass Scavenge Combined
 * Version: v1.3.1 (Unlock) + Combined
 * Last Updated: 2023-09-04 (Unlock part)
 * Author: RedAlert (Unlock) + Sophie "Shinko to Kuma" (Scavenge)
 * Author URL: https://twscripts.dev/ + https://shinko-to-kuma.my-free.website/
 * Approved: t14525689
 * Approved Date: 2021-01-28
 * Mod: JawJaw
 * Description: This combined script unlocks mass scavenging options and then performs mass scavenging.
 */
...
$.getScript(
    ...
    async function () {
        ...
        if (isValidScreen && isValidMode) {
            initUnlock(); // Start with unlock logic
        } else {
                    ...
                    twSDK.getAll(
                        ...
                        () => {
                            ...
                            if (scavengeTable.length === 0) {
                                ...
                                initScavenge(); // Proceed to scavenge after unlock
                            } else {
                                let htmlString = `
                                            ...
                                            (scavengeItem, i) => {
                                                setTimeout(() => {
                                                    ...
                                                    if (
                                                        ...
                                                        initScavenge(); // Proceed to scavenge after unlock completes
                                                    }
                                                }, 250 * i);
                                            }
                                        );
        ...
        // Now the Mass Scavenge Logic (integrated after unlock)
        function initScavenge() {
            ...
            <button class="btn" id = "x" onclick="closeWindow('massScavengeSophie')">
                ...
                <table id="massScavengeSophieTable" class="vis" border="1" style="width: 100%;background-color:${backgroundColor};border-color:${borderColor}">
                    ...
                    <tr style="text-align:center; width:auto; background-color:${headerColor}">
                        <td colspan="10" style="text-align:center; width:auto; background-color:${backgroundColor}; padding:5px;">
                            <font color="${titleColor}">${langShinko[1]}</font>
                        </td>
                    </tr>
                    <tr id="imgRow" style="text-align:center; width:auto; background-color:${backgroundColor}"></tr>
                    <tr style="text-align:center; width:auto; background-color:${headerColor}">
                        <td colspan="10" style="text-align:center; width:auto; background-color:${backgroundColor}; padding:5px;">
                    ...
                    <tr style="text-align:center; width:auto; background-color:${headerColor}">
                        <td style="text-align:center; width:25%; background-color:${backgroundColor}; padding:5px;"><input type="checkbox" ID="category1" name="category1"></td>
                        <td style="text-align:center; width:25%; background-color:${backgroundColor}; padding:5px;"><input type="checkbox" ID="category2" name="category2"></td>
                        <td style="text-align:center; width:25%; background-color:${backgroundColor}; padding:5px;"><input type="checkbox" ID="category3" name="category3"></td>
                        <td style="text-align:center; width:25%; background-color:${backgroundColor}; padding:5px;"><input type="checkbox" ID="category4" name="category4"></td>
                    </tr>
                    <tr style="text-align:center; width:auto; background-color:${headerColor}">
                        <td colspan="10" style="text-align:center; width:auto; background-color:${backgroundColor}; padding:5px;">
                    ...
                    <tr style="text-align:center; width:auto; background-color:${headerColor}">
                        <td style="text-align:center; width:50%; background-color:${headerColor}; padding:5px;">
                            <font color="${titleColor}">Off</font>
                        </td>
                        <td style="text-align:center; width:50%; background-color:${headerColor}; padding:5px;">
                            <font color="${titleColor}">Def</font>
                        </td>
                    </tr>
                    <tr id="settingType" style="text-align:center; width:auto; background-color:${headerColor}">
                        <td style="text-align:center; width:50%; background-color:${backgroundColor}; padding:5px;"><input type="radio" ID="timeSelectorDate" name="timeSelector">Date<br><input type="date" id="offDay" value="${setDayToField(runTimes.off)}"><br><input type="time" id="offTime" value="${setTimeToField(runTimes.off)}"><br><span id="offDisplay"></span></td>
                        <td style="text-align:center; width:50%; background-color:${backgroundColor}; padding:5px;"><input type="radio" ID="timeSelectorHours" name="timeSelector">Hours<br><input type="number" class="runTime_def" value="${runTimes.def}" min="0" max="24" step="0.5"><br><span id="defDisplay"></span></td>
                    </tr>
                    <tr style="text-align:center; width:auto; background-color:${headerColor}">
                        <td colspan="10" style="text-align:center; width:auto; background-color:${backgroundColor}; padding:5px;">
                            <font color="${titleColor}">${langShinko[4]}</font>
                        </td>
                    </tr>
                    <tr style="text-align:center; width:auto; background-color:${headerColor}">
                        <td style="text-align:center; width:50%; background-color:${headerColor}; padding:5px;">
